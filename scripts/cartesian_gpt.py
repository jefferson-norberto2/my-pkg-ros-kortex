...
class ExampleWaypointActionClient:
    ...
    def example_cartesian_waypoint_action(self):
        ...
        client = actionlib.SimpleActionClient('/' + self.robot_name + '/my_gen3_lite_driver', kortex_driver.msg.FollowCartesianTrajectoryAction)
        # /my_gen3_lite/gen3_lite_position_controllers_spawner
        # /my_gen3_lite/base/execute_waypoint_trajectory
        client.wait_for_server()
        rospy.loginfo("Achei o serviço")
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            rospy.loginfo("Passou aqui tabém 1")
        else:
            ...
            rospy.loginfo("Passou aqui tabém 2")
